...
import { ArrowRight, CreditCard, Sparkles, Check, Smartphone } from 'lucide-react';
      ...
      <section className="relative overflow-hidden py-20 md:py-32">
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            <Badge variant="outline" className="mb-6 gap-1.5 px-4 py-1.5 text-sm">
            ...
            <p className="mb-10 text-xl text-muted-foreground md:text-2xl">
              Enable one-tap contact exchange for NFC users, linking directly to the SmartQR app
                ...
                <div className="flex flex-col justify-center space-y-6 p-8 lg:p-12">
                  <div>
                    ...
                    <div className="mb-6 flex items-baseline gap-2">
                      <span className="text-5xl font-bold text-primary">$4.95</span>
                      <span className="text-lg text-muted-foreground">
                        covers shipping & handling
                      </span>
                    </div>
                    <p className="text-lg text-muted-foreground">
                      This premium NFC card enables instant contact sharing with a simple tap.
                      Works seamlessly with any NFC-enabled smartphone.
                    </p>
                  </div>
              ...
              <CardContent className="p-8 md:p-12">
                <div className="text-center">
                  ...
                  <p className="mb-6 text-lg text-muted-foreground">
                    Everyone gets access to the free SmartQR app, even if you don't use NFC. Create
                    and share your digital contact card with QR codes on any device.
                  </p>
                  <div className="mx-auto max-w-2xl space-y-3">
                    <div className="flex items-center justify-center gap-3 rounded-lg bg-background/50 p-4">
                      ...
                      <p className="text-left text-sm">
                        <strong>QR Code Sharing:</strong> Share your contact with anyone, even
                        without NFC
                      </p>
                    </div>
                    <div className="flex items-center justify-center gap-3 rounded-lg bg-background/50 p-4">
                      ...
                      <p className="text-left text-sm">
                        <strong>Real-Time Updates:</strong> Change your info once, update
                    ...
                    <div className="flex items-center justify-center gap-3 rounded-lg bg-background/50 p-4">
                      ...
                      <p className="text-left text-sm">
                        <strong>Cross-Platform:</strong> Works on iOS, Android, and web browsers
                      </p>
                    </div>
                  </div>
                </div>
