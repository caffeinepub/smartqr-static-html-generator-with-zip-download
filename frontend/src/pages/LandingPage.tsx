        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-xl text-muted-foreground md:text-2xl">
              SmartQR offers advanced contact sharing with real-time updates and NFC integration.
            </p>
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
              <div className="flex flex-col justify-center space-y-6">
                ...
                <p className="text-lg text-muted-foreground">
                  Experience seamless contact sharing with our beautifully designed QR contact
                  cards. Share your information instantly with anyone, anywhere.
                </p>
              ...
              <div className="grid gap-8 lg:grid-cols-2">
                ...
                <div className="flex flex-col justify-center space-y-6 p-8 lg:p-12">
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground">
                      Get a physical NFC card that works with a simple tap. No app required for
                      your contacts to receive your information.
                    </p>
                  </div>
